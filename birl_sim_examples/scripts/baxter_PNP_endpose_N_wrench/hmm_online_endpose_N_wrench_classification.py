...
model_save_path = "/home/ben/ML_data/REAL_BAXTER_PICK_N_PLACE_5_18/model/endpose_N_wrench"

figure_save_path = "/home/ben/ML_data/REAL_BAXTER_PICK_N_PLACE_5_18/figure/endpoint_N_wrench"
...
class ROSThread(threading.Thread):
    ...
    def callback_multimodal(self,data):
        ...
        df_append_data = {'.endpoint_state.pose.position.x':[data.endpoint_state.pose.position.x],
                          ...
                          '.wrench_stamped.wrench.force.x':[data.wrench_stamped.wrench.force.x],
