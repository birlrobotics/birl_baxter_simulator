...
def main():
    ...
    #ipdb.set_trace()
    df = pd.read_csv('/home/ben/ML_data/pick_n_place_smach_tag/02/tag_wrench.csv', sep=',')
    X_1 = df.values[df.values[:,11] ==1]
    index_1,column_1 = X_1.shape
    X_2 = df.values[df.values[:,11] ==2]
    index_2,column_2 = X_2.shape
    X_3 = df.values[df.values[:,11] ==3]
    index_3,column_3 = X_3.shape
    X_4 = df.values[df.values[:,11] ==4]
    index_4,column_4 = X_4.shape
    X_5 = df.values[df.values[:,11] ==5]
    index_5,column_5 = X_5.shape

    index = [index_1,index_2,index_3,index_4,index_5]

    X_1_ = X_1[:index_1,5:11]
    X_2_ = X_2[:index_2,5:11]
    X_3_ = X_3[:index_3,5:11]
    X_4_ = X_4[:index_4,5:11]
    X_5_ = X_5[:index_5,5:11]
    ...
    # save the models
    joblib.dump(model_1,"/home/ben/ML_data/pick_n_place_smach_tag/02/model/model_s1.pkl")
    joblib.dump(model_2,"/home/ben/ML_data/pick_n_place_smach_tag/02/model/model_s2.pkl")
    joblib.dump(model_3,"/home/ben/ML_data/pick_n_place_smach_tag/02/model/model_s3.pkl")
    joblib.dump(model_4,"/home/ben/ML_data/pick_n_place_smach_tag/02/model/model_s4.pkl")
    joblib.dump(model_5,"/home/ben/ML_data/pick_n_place_smach_tag/02/model/model_s5.pkl")
