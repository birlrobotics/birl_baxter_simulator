...
def main():
    ...
    pick_object_pose.position.x = 0.755186570003
    pick_object_pose.position.y = -0.104361177768
    pick_object_pose.position.z = -0.0447416463065
    
    place_object_pose.position.x = 0.755186570003
    place_object_pose.position.y = -0.2 
    place_object_pose.position.z = -0.0447416463065
    #RPY = 0 pi 0
